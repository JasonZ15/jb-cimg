...
<body <?php body_class(); ?>>
	...
	<div id="container">
		...
		<header id="header" class="clearfix">
			...
			<a href="http://gmic.greatwallclub.com/cn" class="action-button" target="_blank" id="gmic-sv-brochure" style="margin-top:2px;clear:left;"><span class="color"><span class="text">中文</span></span></a>
