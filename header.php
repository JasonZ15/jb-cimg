...
<body <?php body_class(); ?>>
	...
	<div id="container">
		...
		<header id="header" class="clearfix">
			...
			<a href="http://gmic.greatwallclub.com/reg/" id="go-register" class="action-button"><span class="color" style="padding-left: 16px;"><span class="text" style="font-size: 30px; padding: 12px 23px 14px 17px;">Register</span></span></a>
			<a style="margin-left:5px;" href="http://gmic.greatwallclub.com/sponsors/" id="sponsor" class="action-button"><span class="color" style="padding-left: 16px;"><span class="text" style="font-size: 30px; padding: 12px 23px 14px 17px;"><?php esc_html_e( 'Sponsor', 'Flexible' ); ?></span></span></a>
			<a href="http://gmic.greatwallclub.com/cn" class="action-button" target="_blank" id="gmic-sv-brochure" style="margin-top:8px;margin-right:18px;clear:left;"><span class="color" style="padding-left:12px;"><span class="text">中文</span></span></a>
			<p class="social-buttons" style="clear:none;"><a id="fb" href="http://www.facebook.com/theGMIC" target="_blank" ><img src="<?php echo get_template_directory_uri(); ?>/images/social-buttons.png" /></a><a id="tt" href="http://www.twitter.com/theGMIC" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/social-buttons-02.png" /></a><a id="in" href="http://www.linkedin.com/groups/Mobile-Internet-Great-Wall-Club-2516273" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/social-buttons-03.png" /></a><a id="em" href="mailto: gmic@greatwallclub.com" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/social-buttons-05.png" /></a><a style="display: none;" id="chinese-overview" href="http://gmic.greatwallclub.com/cn" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/social-buttons-06.png" /></a></p>
