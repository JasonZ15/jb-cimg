...
<body <?php body_class(); ?>>
	...
	<div id="container">
		...
		<header id="header" class="clearfix">
			...
			<a href="/register/" id="go-register" class="action-button"><span class="color" style="padding-left: 16px;"><span class="text" style="font-size: 30px; padding: 12px 23px 14px 17px;">Register</span></span></a>
