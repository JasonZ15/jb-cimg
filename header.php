...
<body <?php body_class(); ?>>
	...
	<div id="container">
		...
		<header id="header" class="clearfix">
			...
			<a href="http://gmic.greatwallclub.com/cn" class="action-button" id="gmic-sv-brochure" style="margin-top:2px;position: fixed; top:0; right:0;z-index: 999999999;"><span class="color"><span class="text">中文</span></span></a>
			<a href="http://gmic.greatwallclub.com/reg/" id="go-register" class="action-button" style="clear:left;"><span class="color" style="padding-left: 16px;"><span class="text" style="font-size: 30px; padding: 12px 23px 14px 17px;">Register</span></span></a>
