	...
	<div id="left-area">
		<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>				
			<article id="post-<?php the_ID(); ?>" <?php post_class('entry clearfix'); ?>>
				<a style="float: right;" href="/previous-speakers" id="previous-speakers" class="action-button"><span class="color"><span class="text">Previous Speakers at GMIC</span></span></a>
							...
							<?php } ?>
									...
									<div class="et_pt_portfolio_item">
										...
										<?php if ($et_ptemplate_showtitle) { ?>
											<h2 class="et_pt_portfolio_title" style="padding-bottom: 8px; font-size: 18px;"><!--<a href="<?php the_permalink(); ?>" style="font-size: 18px;">--></a><?php echo $et_portfolio_title; ?></h2>
										<?php } ?>
